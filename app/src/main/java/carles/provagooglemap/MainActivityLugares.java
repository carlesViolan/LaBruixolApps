...
public class MainActivityLugares extends AppCompatActivity implements LocationListener {
...
//        }
        ...
        setContentView(R.layout.activity_mainlugares);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Intent i = new Intent(MainActivityLugares.this, VistaLugar.class);
                        i.putExtra("id", id);
                        startActivity(i);
                    }
                })
